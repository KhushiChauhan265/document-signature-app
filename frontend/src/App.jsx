        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-xs text-slate-400 mt-1">Day 2: Secure Access Gate</p>
            </div>
      ...
      {view === 'dashboard' && (
        <div className="flex-1 flex flex-col">
          ...
          <main className="flex-1 max-w-4xl w-full mx-auto p-6 lg:p-8 flex flex-col gap-6">
            ...
            {/* Document Workspace (Placeholder empty state ready for Day 3/4) */}
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 flex flex-col items-center justify-center text-center mt-4">
              ...
              <p className="text-[11px] text-slate-400 max-w-sm mt-1.5 leading-relaxed">
                Your workspace is empty. Documents will appear here once authentication and document upload flows are configured.
              </p>
            </div>
